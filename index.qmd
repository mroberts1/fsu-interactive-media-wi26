...
[Blackboard](https://blackboard.fitchburgstate.edu/ultra/courses/_106098_1/cl/outline)</small>\
...
Friday 26 December Class begins

Thursday 2 January\
**DEADLINE** 3 Response Posts due on Discord due by end of week 1 (Thur 1 Jan).  **DEADLINE** Commentary Paper #1\*\* (submit on Blackboard)

*Week 2* F 01/09/26

**DEADLINE** 3 Response Posts due on Discord by end of week 2 (Thur 8 Jan).  **DEADLINE** Commentary Paper #2\*\* (submit on Blackboard)

*Week 3* F 01/09/26

**DEADLINE** 3 Response Posts due on Discord by end of week 3 (Thur 15 Jan).\
**DEADLINE: Commentary Paper #3** (submit on Blackboard)

*Week 4* M 01/19/26

**DEADLINE: Special Topics Paper** (submitted on Blackboard)
